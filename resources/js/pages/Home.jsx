                    ...
                    <div className="grid md:grid-cols-12 gap-10 items-center">
                        ...
                        <div className="md:col-span-9">
                            {settings?.hero_greeting && (
                                <p className="text-emerald-400 font-medium mb-4">{settings.hero_greeting}</p>
                            )}
                            {settings?.hero_name && (
                                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight">
                                    {settings.hero_name}
                                    {settings?.hero_subtitle && (
                                        <span className="block text-emerald-500">{settings.hero_subtitle}</span>
                                    )}
                                </h1>
                            )}
                            ...
                            <div className="mt-8 flex flex-wrap gap-4">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-6 py-3 border border-emerald-500/50 text-emerald-400 rounded-lg hover:bg-emerald-600/10 transition-colors font-medium"
                                >
                ...
                <section className="py-20 border-t border-white/5">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between mb-10">
                            ...
                            <Link href="/projects" className="text-emerald-400 hover:text-emerald-300 text-sm font-medium flex items-center gap-1">
                                        ...
                                        return tech.length > 0 && (
                                            <div className="mt-4 flex flex-wrap gap-2">
                                                {tech.slice(0, 4).map((t) => (
                                                    <span key={t} className="px-2 py-0.5 text-xs rounded-full bg-emerald-600/20 text-emerald-300 border border-emerald-500/30">{t}</span>
                                                ))}
                                            </div>
                                        );
                                    })()}
                ...
                <section className="py-20 border-t border-white/5">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between mb-10">
                            ...
                            <Link href="/skills" className="text-emerald-400 hover:text-emerald-300 text-sm font-medium flex items-center gap-1">View all <ArrowRight className="w-4 h-4" /></Link>
                        </div>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {skills.slice(0, 8).map((skill) => (
                                <div key={skill.id} className="rounded-lg border border-white/10 bg-white/5 p-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-lg bg-emerald-600/20 flex items-center justify-center"><Code className="w-5 h-5 text-emerald-400" /></div>
                                        <div>
                                    ...
                                    {skill.level != null && (
                                        <div className="mt-3">
                                            <div className="w-full bg-white/10 rounded-full h-1.5"><div className="bg-emerald-500 h-1.5 rounded-full" style={{ width: `${skill.level}%` }} /></div>
                                        </div>
                                    )}
                                </div>
                            ))}
                ...
                <section className="py-20 border-t border-white/5">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between mb-10">
                            ...
                            <Link href="/blog" className="text-emerald-400 hover:text-emerald-300 text-sm font-medium flex items-center gap-1">View all <ArrowRight className="w-4 h-4" /></Link>
                        </div>
                        <div className="grid md:grid-cols-3 gap-6">
                            {recentPosts.map((post) => (
                                <Link key={post.id} href={`/blog/${post.slug}`} className="group block rounded-xl border border-white/10 bg-white/5 p-6 hover:border-emerald-500/50 hover:bg-white/10 transition-all">
                                    ...
                                    <h3 className="text-lg font-semibold text-white group-hover:text-emerald-400 transition-colors">{post.title}</h3>
            ...
            {testimonials.length > 0 && (
                <section className="py-20 border-t border-white/5">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {testimonials.map((t) => (
                                <div key={t.id} className="rounded-xl border border-white/10 bg-white/5 p-6 hover:border-emerald-500/50 transition-all">
