...
export default function PublicLayout({ children, settings }) {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <footer className="border-t border-gray-200 py-8" style={{
                backgroundColor: settings?.footer_bg_color || '#f9fafb',
                fontFamily: settings?.footer_font || 'inherit',
                fontSize: settings?.footer_font_size || '14px',
                color: settings?.footer_color || '#6b7280',
