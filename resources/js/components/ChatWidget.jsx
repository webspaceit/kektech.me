                    ...
                    {!started ? (
                        <form onSubmit={startChat} className="p-4 flex-1 flex flex-col gap-3">
                            ...
                            <input
                                ...
                                required
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm dark:bg-gray-700 dark:text-white placeholder:text-black dark:placeholder:text-gray-500"
                            />
                            <input
                                type="email"
                        ...
                        <>
                            ...
                            <form onSubmit={sendMessage} className="p-2 border-t border-gray-200 dark:border-gray-700 flex gap-1">
                                <input
                                    ...
                                    className="flex-1 px-2 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-white placeholder:text-black dark:placeholder:text-gray-500"
                                />
